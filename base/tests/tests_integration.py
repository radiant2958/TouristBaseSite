...
async def test_booking_form_submission_and_message_sending():
    ...
    with patch('base.telegram_bot.tasks.send_message_to_telegram', new_callable=AsyncMock) as mock_send:
        ...
        assert str(messages[0]) == "Бронирование успешно создано и сообщение отправлено."
